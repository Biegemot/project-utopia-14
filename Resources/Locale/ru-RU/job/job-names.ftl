...
job-name-security = миротворец
job-name-cadet = послушник
...
JobScientist = учёный
JobSecurityCadet = послушник
JobSecurityOfficer = миротворец
