...
ent-SignAiUpload = знак "загрузка ИИ"
    .desc = Знак, указывающий на присутствие ИИ.
ent-SignArcade = знак "нет играм"
    .desc = Знак, напоминающий, что Утопия не терпит лентяев
...
ent-SignHead = знак "глава"
    .desc = Официальный знак, указывающий на место обитания сертифицированного Галактическим Советом главы персонала
ent-SignConference = знак "конференц-зал"
    .desc = Место проведения собраний руководителей станции
...
ent-SignLawyer = знак "закон"
    .desc = Знак, указывающий на наличие верховенства закона.
...
ent-SignServer = знак "серверная"
    .desc = Скопление серверов станции для обеспечения связи
...
ent-SignZomlab = знак "зомби-лаборатория"
    .desc = Последние остатки закрытого исследовательского проекта ОТРЕДАКТИРОВАНО, целью которого было использование силы Ромерола. Интересно, чем всё закончилось...
...
ent-SignSecurity = знак "миротворцы"
    .desc = Знак, изображающий эмблему миротворцев
