...
ent-PosterContrabandKosmicheskayaStantsiya = Утопии существовать НЕ МОЖЕТ!
    .desc = Плакат, скандирующий о том, что Руководство портит понимание о смысле утопии
...
ent-PosterLegitHereForYourSafety = Утопия - закон!
    .desc = Постер, восхваляющий Утопию и её законы в целом. Следуйте им во избежание проблем!
ent-PosterLegitNanotrasenLogo = Логотип Утопии
    .desc = Постер, на котором изображён логотип станции "Утопия"
ent-PosterLegitCleanliness = Знай Врага!
    .desc = Постер, агитирующий противостоянию остаткам нечисти НаноТрейзен
ent-PosterLegitHelpOthers = Сдай предателя!
    .desc = Постер, призывающий сдавать информацию о предателях Утопии и её руководства
ent-PosterLegitBuild = Чини!
    .desc = Постер, восхваляющий команду инженеров станции
ent-PosterLegitBlessThisSpess = Слава Утопии!
    .desc = Утопия гордится вами, и вы обязаны гордиться Утопией.
ent-PosterLegitScience = Наука
    .desc = Постер, восхваляющий команду учёных на станции
ent-PosterLegitIan = Гордость
    .desc = Постер, призывающий гордиться руководством станции
ent-PosterLegitObey = Подчинись
    .desc = Постер, приказывающий подчиняться отряду миротворцев
ent-PosterLegitWalk = Ходи
    .desc = Постер, призывающий передвигаться по станции медленным шагом
ent-PosterLegitStateLaws = ИИ страж порядка
    .desc = Постер, олицетворяющий подчинение ИИ перед законами Утопии
ent-PosterLegitLoveIan = Мир Утопии
    .desc = Важно любить Утопию так же, как и Утопия любит ВАС
ent-PosterLegitSpaceCops = Миротворцы
    .desc = Постер, показывающий важность и надёжность отряда миротворцев
ent-PosterLegitUeNo = Ue No
    .desc = Плакат целиком на японском языке.
ent-PosterLegitGetYourLEGS = Ложь - истина
    .desc = Руководство Утопии не способно на враньё. Вы обязаны быть искренней перед ней.
ent-PosterLegitDoNotQuestion = Не задавай вопросов
    .desc = Не задавай лишних вопросов. Знание наказуемо.
ent-PosterLegitWorkForAFuture = Работай во благо Утопии
    .desc = Постер, призывающий работать во благо Утопии
...
ent-PosterLegitSafetyReport = Безопасность: Доложи
    .desc = Постер, обязывающий докладывать обо всей подозрительной активности, в том числе членов экипажа
ent-PosterLegitReportCrimes = Доложи обо всех
    .desc = Ваш знакомый не согласен с законами и принципами Утопии? Ты обязан доложить об этом!
...
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков Галактического Совета
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти Nanotrasen сегодня!
ent-PosterLegitNanomichiAd = Записывающее устройство - успех
    .desc = Плакат, на котором изображена касета диктофона. Так.. На всякий случай.
...
ent-PosterLegitNoERP = НЕТ НТ!
    .desc = Любая активность, намекающая на присутствие подонков НТ должна быть истреблена!
...
ent-PosterLegitSecWatch = Закон всё видит
    .desc = Плакат, напоминающий, что Руководство станции может следить за вашими действиями. Не совершайте ошибок.
...
ent-PosterLegitRenault = Плакат с Алисой
    .desc = Йап.
ent-PosterLegitNTTGC = Тактическая карточная игра Галактического совета
    .desc = Реклама новой ТКИ от Галактического Совета: ПОКУПАЙТЕ БОЛЬШЕ КАРТОЧЕК.
