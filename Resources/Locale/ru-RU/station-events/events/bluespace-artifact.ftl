bluespace-artifact-event-announcement = Зафиксированы признаки блюспейс-аномалии. Всем гражданам Утопии предписано фиксировать любые проявления феноменов и немедленно передавать сведения о { $sighting }.
